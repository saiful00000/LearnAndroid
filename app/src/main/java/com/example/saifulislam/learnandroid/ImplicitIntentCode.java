...
public class ImplicitIntentCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_implicit_intent_code);

        //setup the toolbar
        setUpTheToolbar();

        Description.header = "Implicit Intent";
        Description.description = getString(R.string.implicitintent_description);
        Java.cdJava = CodeJava.implicitIntentJava;
        XML.cdXML = CodeXML.implicitIntentXML;
        Manifesto.cdMan = CodeManifest.implicitIntentMan;
