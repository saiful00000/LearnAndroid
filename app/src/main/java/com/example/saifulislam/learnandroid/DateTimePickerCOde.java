...
public class DateTimePickerCOde extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_time_picker_code);

        //setup the toolbar
        setUpTheToolbar();

        Description.header = "Time Picker";
        Description.description = getString(R.string.timePicker_description);
        Java.cdJava = CodeJava.dateTimePickerJava;
        XML.cdXML = CodeXML.dateTimePickerXML;
        Manifesto.cdMan = "";
