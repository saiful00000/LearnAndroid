...
public class SwitchCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Description.header = "Switch";
        Description.description = getString(R.string.switch_description);
        Java.cdJava = CodeJava.switchJava;
        XML.cdXML = CodeXML.switchXML;
        Manifesto.cdMan = CodeManifest.switchMan;
