...
import com.example.saifulislam.learnandroid.fragments.FragmentActivityOthers;
...
public class FragmentCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Description.description = getString(R.string.fragment_description);
        Java.cdJava = CodeJava.fragmentJava;
        XML.cdXML = CodeXML.fragmentXML;
        Manifesto.cdMan = CodeManifest.fragmentMan;
        FragmentActivityOthers.headerOne = "Fragment classes";
        FragmentActivityOthers.codeOthersOne = CodeOthers.fragmentOther1;
        FragmentActivityOthers.languageOne = "java";
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.other_nav_item:
                    currentFragment = new FragmentActivityOthers();
                    break;
            }
