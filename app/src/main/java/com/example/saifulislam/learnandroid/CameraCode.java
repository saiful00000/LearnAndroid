...
public class CameraCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Description.header = "Camera";
        Description.description = getString(R.string.camera_description);
        Java.cdJava = CodeJava.cameraJava;
        XML.cdXML = CodeXML.cameraXML;
        Manifesto.cdMan = CodeManifest.cameraMan;
