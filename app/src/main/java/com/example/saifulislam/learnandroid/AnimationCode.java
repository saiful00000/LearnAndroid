...
import com.example.saifulislam.learnandroid.fragments.AnimationFragment;
...
public class AnimationCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Description.header = "Animation";
        Description.description = getString(R.string.animation_description);
        Java.cdJava = CodeJava.animationJava;
        XML.cdXML = CodeXML.animationXML;
        Manifesto.cdMan = CodeManifest.animationMan;
