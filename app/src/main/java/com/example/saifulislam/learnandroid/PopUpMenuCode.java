...
public class PopUpMenuCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_up_menu_code);

        setUpTheToolbar();

        Description.header = "PopUp Menu";
        Description.description = getString(R.string.popupmenu_description);
        Java.cdJava = CodeJava.popUpMenuJava;
        XML.cdXML = CodeXML.popUpMenuXML;
        Manifesto.cdMan = CodeManifest.popUpMenuMan;
        Others.headerOne = "res/menu/popup_menu.xml";
        Others.codeOthersOne = CodeOthers.popUpMenuOthers1;
