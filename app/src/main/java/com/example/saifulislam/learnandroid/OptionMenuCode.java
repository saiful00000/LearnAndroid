...
public class OptionMenuCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Description.header = "Option Menu";
        Description.description = getString(R.string.option_menu_description);
        Java.cdJava = CodeJava.optionMenuJava;
        XML.cdXML = CodeXML.optionMenuXML;
        Manifesto.cdMan = CodeManifest.optionMenuMan;
        Others.headerOne = "game_menu.xml\nPath : res/menu/game_menu.xml";
        Others.codeOthersOne = CodeOthers.optionMenuOthersXML;
