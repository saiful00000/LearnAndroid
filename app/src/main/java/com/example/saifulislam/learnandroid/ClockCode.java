...
public class ClockCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clock_code);

        //setup the toolbar
        setUpTheToolbar();

        Description.header = "Clock";
        Description.description = getString(R.string.clock_description);
        Java.cdJava = CodeJava.clockJava;
        XML.cdXML = CodeXML.clockXML;
        Manifesto.cdMan = "";
