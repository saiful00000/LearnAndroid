...
public class ScrollViewCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scroll_view_code);

        setUpTheToolbar();

        Description.header = "ScrollView";
        Description.description = getString(R.string.scroll_view_description);
        Java.cdJava = CodeJava.scrollViewJava;
        XML.cdXML = CodeXML.scrollViewXML;
        Manifesto.cdMan = CodeManifest.scrollViewMan;
