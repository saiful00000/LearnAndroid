...
public class SeekBarCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seek_bar_code);

        setUpTheToolbar();

        Description.header = "SeekBar COde";
        Description.description = getString(R.string.seekbar_description).toString();
        Java.cdJava = CodeJava.seekBarJava;
        XML.cdXML = CodeXML.seekBarXML;
        Manifesto.cdMan = CodeManifest.seekBarMan;
