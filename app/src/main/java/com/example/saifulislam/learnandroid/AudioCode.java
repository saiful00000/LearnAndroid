...
public class AudioCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio_code);

        // set the toolbar
        setUpTheToolbar();

        Description.header = "Audio";
        Java.cdJava = CodeJava.auodioJava;
        XML.cdXML = CodeXML.auodioXML;
        Manifesto.cdMan = CodeManifest.auodioMan;
