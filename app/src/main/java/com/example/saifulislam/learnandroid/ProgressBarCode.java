...
public class ProgressBarCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progress_bar_code);

        setUpTheToolbar();

        Description.header = "ProgressBar";
        Description.description = getString(R.string.prgressbar_description);
        Java.cdJava = CodeJava.progressBarJava;
        XML.cdXML = CodeXML.progressBarXML;
        Manifesto.cdMan = CodeManifest.progressBarMan;
