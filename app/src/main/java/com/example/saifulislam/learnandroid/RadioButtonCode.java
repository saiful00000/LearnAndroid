...
public class RadioButtonCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radio_button_code);

        setUpTheToolbar();

        Description.header = "RadioButton Code";
        Description.description = getString(R.string.radiobutton_description);
        Java.cdJava = CodeJava.radioButtonJava;
        XML.cdXML = CodeXML.radioButtonXML;
        Manifesto.cdMan = CodeManifest.radioButtonMan;
