...
public class ToastCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toast_code);

        setUpTheToolbar();

        Description.header = "Toast";
        Description.description = getString(R.string.toast_description);
        Java.cdJava = CodeJava.toastJava;
        XML.cdXML = CodeXML.toastXML;
        Manifesto.cdMan = CodeManifest.toastMan;
        Others.headerOne = "custom_toast_background.xml";
        Others.codeOthersOne = CodeOthers.toastOtherCode1;
        Others.headerTwo = "msg_block.xml";
        Others.codeOthersTwo = CodeOthers.toastOtherCode2;
        Others.languageOne = "xml";
        Others.languageTow = "xml";
