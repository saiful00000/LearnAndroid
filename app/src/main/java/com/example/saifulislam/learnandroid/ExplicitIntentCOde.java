...
public class ExplicitIntentCOde extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explicit_intent_code);
        //setup the toolbar
        setUpTheToolbar();

        Description.header = "Explicit Intent";
        Description.description = getString(R.string.explicitintent_description);
        Java.cdJava = CodeJava.explicitIntentJava;
        XML.cdXML = CodeXML.explicitIntentXML;
        Manifesto.cdMan = CodeManifest.explicitIntentMan;
